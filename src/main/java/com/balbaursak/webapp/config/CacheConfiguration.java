package com.balbaursak.webapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.balbaursak.webapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.balbaursak.webapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
