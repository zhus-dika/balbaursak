            ...
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="contains" id="produce-contains"
                            :class="{'valid': !$v.produce.contains.$invalid, 'invalid': $v.produce.contains.$invalid }" v-model="$v.produce.contains.$model"  required></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="produce-description"
                            :class="{'valid': !$v.produce.description.$invalid, 'invalid': $v.produce.description.$invalid }" v-model="$v.produce.description.$model"  required></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="produce-category" name="category" v-model="produce.category" required>
                            <option v-if="!produce.category" v-bind:value="null" selected></option>
                            <option v-bind:value="produce.category && categoryOption.id === produce.category.id ? produce.category : categoryOption" v-for="categoryOption in categories" :key="categoryOption.id">{{categoryOption.name}}</option>
                        </select>
                    </div>
                    <div v-if="$v.produce.category.$anyDirty && $v.produce.category.$invalid">
                        <small class="form-text text-danger" v-if="!$v.produce.category.required" v-text="$t('entity.validation.required')">
                            This field is required.
                        </small>
                    </div>
                </div>
