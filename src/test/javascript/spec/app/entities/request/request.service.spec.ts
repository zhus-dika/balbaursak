...
describe('Service Tests', () => {
  describe('Request Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Request(0, currentDate, 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Request', async () => {
      ...
      it('should not return a list of Request', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
