...
describe('Service Tests', () => {
  describe('Feedback Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Feedback(0, currentDate, 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Feedback', async () => {
      ...
      it('should not update a Feedback', async () => {
      ...
      it('should not return a list of Feedback', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Feedback', async () => {
